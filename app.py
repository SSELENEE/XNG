...
def save_uploaded_noaa_shapefile_set(day: str, module: str, uploaded_files: list) -> dict:
    """
    Save NOAA shapefile set.

    Supported upload modes:
    1) ZIP upload: recommended for iPhone/mobile.
       ZIP must contain .shp + .dbf + .shx.
    2) Multi-file upload: select .shp/.dbf/.shx/.prj/etc together.

    Required minimum after extraction/save:
    - .shp
    - .dbf
    - .shx
    """
